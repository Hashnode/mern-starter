    ...
    return (
      <div>
        <div className={viceVersa}>
          <a className={styles['add-comment-btn']} href="#" onClick={() => this.changeShowBtn()}><FormattedMessage id="addComment" /></a>
        </div>
        <div className={cls}>
          <div className={styles['form-content']}>
            ...
            <a className={styles['post-cancel-button']} href="#" onClick={() => this.setState({ show: false })}><FormattedMessage id="cancel" /></a>
